        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-md-5 col-sm-8 col-11">
            <div className="custom-bg p-3 rounded mt-3 text-white">
              ...
              <p className="fs-6 mb-2">Connect us on our Social Handles for further Updates from the club.</p>

              <a
                className="btn btn-sm btn-outline-primary m-1 rounded border-0"
                href="https://www.instagram.com/blocsoc.iiitdwd/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA=="
                target="_blank"
                role="button"
              >
                <svg
              ...
              <a
                className="btn btn-sm btn-outline-primary m-1 rounded border-0"
                href="https://x.com/Blocsoc_iiit?s=20"
                target="_blank"
                role="button"
              >
                <svg
              ...
              <a
                className="btn btn-sm btn-outline-primary m-1 rounded border-0"
                href="https://www.linkedin.com/company/blocsoc-iiitdwd/mycompany/"
                target="_blank"
                role="button"
              >
                <svg
